                    ...
                    <div class="card-body">
                        ...
                        <ul class="fa-ul">
                            <div class="alert alert-success">
                                You successfully purchased <span style="color:#ff5835">{{$plan->name}}</span> plan.
                            </div>
                        </ul>
                        <a href="{{route('pricing.index')}}"><div class="btn btn-block btn-primary text-uppercase">Now you can return back to app to use features</div></a>
                    </div>
                </div>
            </div>
        </div>
